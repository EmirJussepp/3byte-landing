export default function HeroVisual() {
  return (
    <div className="relative w-full max-w-[460px] mx-auto lg:mx-0">
      ...
      {/* Ventana tipo editor */}
      <div className="relative rounded-lg border border-white/[0.09] bg-[#0d0d11]/90 backdrop-blur-xl overflow-hidden shadow-2xl shadow-black/40">
        {/* Barra de la ventana */}
      ...
      <div className="absolute -bottom-5 -right-3 sm:-right-5 rounded-lg border border-white/[0.09] bg-[#13131a]/95 backdrop-blur-xl px-4 py-3 shadow-xl shadow-black/40">
