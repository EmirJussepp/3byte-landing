      ...
      <div className="flex flex-col gap-5 md:gap-6">
        {projects.map((p, i) => (
          <FadeIn key={i} delay={i * 0.07}>
            <div className="group rounded-xl border border-white/[0.07] bg-[#0d0d11] hover:border-white/[0.14] transition-colors duration-300 p-5 md:p-7">
              <div className="grid lg:grid-cols-2 gap-6 lg:gap-9 items-center">
                ...
                <div className={i % 2 === 1 ? "lg:order-2" : ""}>
                  <div className="relative">
                    ...
                    />
                    <div className="relative rounded-lg border border-white/[0.09] overflow-hidden shadow-xl shadow-black/40">
                ...
                <div className={i % 2 === 1 ? "lg:order-1" : ""}>
                  <div className={`inline-flex items-center gap-1.5 font-mono text-[0.58rem] font-bold mb-4 px-2.5 py-1 rounded-full border border-white/[0.08] bg-white/[0.03] ${p.badge.text}`}>
                    <span className={`w-1.5 h-1.5 rounded-full ${p.badge.dot}`} />
                    {p.badge.label}
                  </div>

                  <div className="flex items-center gap-3 mb-3.5">
                    <div className="shrink-0 w-11 h-11 rounded-lg bg-white/[0.04] border border-white/[0.07] flex items-center justify-center overflow-hidden p-1.5">
                      <Image
                        src={p.logo}
                        alt={p.name}
                        width={44}
